...
public class Menu  {
    ...
    public void checkIfEmailExists(String email) {
     ...
     public static void main(String args[]) {
       ...
       Notebook n1 = new Notebook("Lenovo",450,"Ena laptop idaniko gia foithtes!",100,1067429,3);
       Notebook n2 = new Notebook("Acer Aspire",699,"Ena laptop poy tha ikanopoiei ton meso gamer",100,1061215,3);
       Notebook n3 = new Notebook("Lenovo",450,"Ena laptop idaniko gia foithtes!",100,1061435,3);
